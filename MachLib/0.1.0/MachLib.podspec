#
# Be sure to run `pod lib lint MachLib.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'MachLib'
  s.version          = '0.1.0'
  s.summary          = 'MachLib. 是一个开发者的私有工具类库'
...
#http://www.cnblogs.com/brycezhang/p/4117180.html
  ...
  s.source           = { :git => 'https://github.com/Housl/MachLib.git', :tag => s.version.to_s }
